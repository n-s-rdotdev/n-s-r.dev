    ...
    <div className="isolate w-full min-h-dvh">
      <div className="max-w-screen overflow-x-clip flex min-h-dvh flex-col">
        ...
        <div className="mx-auto flex w-full max-w-4xl flex-1">
          <div className="grid flex-1 grid-cols-1 grid-rows-[1fr_1px_auto_1px_auto] justify-center [--gutter-width:2.5rem] md:grid-cols-[var(--gutter-width)_minmax(0,var(--breakpoint-2xl))_var(--gutter-width)]">
