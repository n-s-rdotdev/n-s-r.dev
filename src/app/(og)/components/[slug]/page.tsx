...
import { Block, BlockSeparator } from "@/components/block";
  ...
  return (
    <>
      ...
      <Block>
        ...
        {/* <BlockContent> */}
        <Prose>
          <h1 className="p-2 mb-0 text-3xl font-semibold tracking-tight">{doc.metadata.title}</h1>
          <Separator />
          <p className="text-muted-foreground px-2">{doc.metadata.description}</p>

          <div className="p-2">
            <InlineTOC items={toc} className="p-2" />
          </div>
